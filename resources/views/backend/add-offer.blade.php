                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('offers.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="offer_description" name="offer_description" rows="6"></textarea>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="terms" class="form-label">Terms & Conditions</label>
                                    <textarea class="form-control" id="terms" name="terms" rows="6"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-gradient-purple">Save Offer</button>
