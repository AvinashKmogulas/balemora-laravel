    ...
    <div class="container">
      <div class="row first-overview">
        ...
        <div class="col-md-6">
          ...
          <p class="">Unwind in thoughtfully designed spaces where comfort meets elegance. Whether seeking a peaceful retreat or a luxurious escape, enjoy breathtaking views, premium amenities, and warm hospitality for a truly memorable stay.</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="room-details">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                tabindex="0">
                <p>Nestled in the serenity of the Himalayas, these wooden cottages combine rustic charm with modern
                  comfort. Thoughtfully designed for privacy and well-being, each space opens to panoramic mountain
                  vistas, inviting you to reconnect with nature, restore balance, and experience a truly unforgettable
                  wellness escape. </p>
                <div class="details-icons">
                  ...
                  <div class="icon-text">
                    <div class="icon"><img src="assets/icons/fork.png" alt="Meals"> </div>
                    <div class="text">All Meals Inclusive </div>
                  </div>
                  <div class="icon-text">
                    <div class="icon"><img src="assets/icons/wifi.png" alt="wifi"> </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">What type of accommodations do you offer? </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">We offer eco-friendly wooden cottages and a therapy arena with serene views and Ayurvedic décor. </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                                        aria-expanded="false" aria-controls="collapseTwo">Are meals included in the stay? </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">Yes, three Ayurvedic meals are included daily, tailored to your dosha and treatment plan. </div>
                                </div>
                            </div>
