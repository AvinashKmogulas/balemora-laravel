    ...
    <section class="section-padding ">
        <div class="container">
            <div class="row first-overview">
                ...
                <div class="col-md-6">
                    <p>Make the most of your stay with special offers and curated experiences. Whether it’s a weekend escape, an extended getaway or a mindful break, enjoy exclusive benefits, premium comforts, and unforgettable moments.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-padding color-bg">
        <div class="container mb-4">
            <div class="row offer-categories">
                <div class="col-md-6"><img src="assets/images/offers/Long-Stay.jpg" alt="" class="w-100"> </div>
                <div class="col-md-6">
