        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-12 col-sm-12">
                <div class="quick-link-box">
                    ...
                    <ul>
                        ...
                        <li><a class="text-white" href="balemora-wellness.php">Balemora Wellness</a></li>
                        <li><a class="text-white" href="about-us.php">About Us</a></li>
                        <li><a class="text-white" href="gallery.php">Gallery</a></li>
                        <li><a class="text-white" href="special-offers.php">Special Offers</a></li>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="footer-resort">
                    <h6>Our Retreats</h6>
                    <p><a href="balemora-lucknow-overview.php"><b>Lucknow</b><br>Balemora NH27 Lucknow, Uttar Pradesh</a> </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <p class="f-info">
                    <a href="mailto:customercare@balemorawellnessretreats.com"><i class="fa-solid fa-envelope"></i> customercare@balemorawellnessretreats.com </a>
                </p>
                <p class="f-info">
                    <a href="mailto:ceo.dr.sumitoberoi@balemorawellnessretreats.com"><i class="fa-solid fa-envelope"></i> ceo.dr.sumitoberoi@balemorawellnessretreats.com </a>
                </p>
                <h6>Follow Us</h6>
