        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-12 col-sm-12">
                <div class="quick-link-box">
                    <h6>Quick Links</h6>
                    <ul>
                        <li><a class="text-white" href="{{ route('almora') }}">Home</a></li>
                        ...
                        <li><a class="text-white" href="{{ route('galleryBalemoraAlmora') }}">Gallery</a></li>
                        <li><a class="text-white" href="{{ route('specialOfferBalemoraAlmora') }}">Special Offers</a>
                        </li>
                        <li><a class="text-white" href="{{ route('contactBalemoraAlmora') }}">Contact Us</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="footer-resort">
                    ...
                    <p><a href="{{ route('lucknow') }}"><b>Lucknow</b><br>Balemora NH27 Lucknow, Uttar
                            Pradesh</a> </p>
                    <p><a href="{{ route('almora') }}"><b>Almora</b><br>Balemora Almora, Uttarakhand</a> </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
                <h6>Contact Us</h6>
