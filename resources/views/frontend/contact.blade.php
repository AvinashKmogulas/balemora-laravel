...
@section('content')
    <main>
        ...
        <section class="section-padding color-bg">
            <div class="container">
                <div class="row mb-5 pb-5 flex-lg-row-reverse">
                    <div class="col-md-6 p-0">
                        <div class="contact-details-box">
                            <h2 class="mb-5">Balemora NH27 Lucknow</h2>
                            <div class="contact-details">

                                <a href="https://maps.app.goo.gl/cxKwbm3FynMvUHLo8" target="_blank" class="details-box">
                                    <span class="icon">
                ...
                <div class="row">
                    <div class="col-md-6 p-0">
                        <div class="contact-details-box">
                            ...
                            <div class="contact-details">
                                <a href="https://maps.app.goo.gl/t72xdfpwseerPCQY6" target="_blank" class="details-box">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Our resort features lush green gardens, a wellness library, Yoga zone, kids'
                                            play zone, outdoor games and water bodies.
                                        </div>
                                    </div>
                                </div>
