...
@section('content')
    <main>
        ...
        <section class="section-padding ">
            <div class="container">
                <div class="row first-overview">
                    ...
                    <div class="col-md-6">
                        <p>Unwind in thoughtfully designed spaces where comfort meets elegance. Whether seeking a peaceful
                            retreat or a luxurious escape, enjoy breathtaking views, premium amenities, and warm hospitality
                            for a truly memorable stay.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="section-padding color-bg">
                ...
                <div class="row rooms-category">
                    <div class="col-md-6">
                        <div class="owl-carousel owl-theme room-page-slider">
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/family-cottage1.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/family-cottage2.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/family-cottage3.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/family-cottage4.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/family-cottage5.jpg') }}"
                                    alt="" class="w-100"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="room-details">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane show active" id="home-tab-pane" role="tabpanel"
                                    ...
                                    <p>These crafted wooden cottages blend rustic elegance with modern indulgence. Offering
                                        an exclusive
                                        escape where luxury meets nature’s tranquility, they feature spacious interiors and
                                        thoughtful
                                    ...
                                    <div class="details-icons">
                                        <div class="icon-text">
                                            <div class="icon"><img src="{{ URL::asset('assets/icons/bed.png') }}"
                                                    alt="king bed"> </div>
                                            <div class="text">Living Room + Double Bedroom + Double Bed on Deck</div>
                                        </div>
                                        <div class="icon-text">
                                        ...
                                        <div class="icon-text">
                                            <div class="icon"><img src="{{ URL::asset('assets/icons/size-new.png') }}"
                                                    alt="room size"> </div>
                                ...
                                <div class="tab-pane" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                                    ...
                                    <div class="features-box">
                                        <ul>
                                            ...
                                            <li>Living Room + Double Bedroom + Double Bed on Deck</li>
                                            <!-- <li>Double Bedroom + 2 Double Beds on Decks </li> -->
                                        </ul>
            ...
            <div class="container">
                <div class="row rooms-category flex-lg-row-reverse">
                    <div class="col-md-6">
                        <div class="owl-carousel owl-theme room-page-slider">
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/boat-house1.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/boat-house2.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/boat-house3.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/boat-house4.jpg') }}"
                                    alt="" class="w-100"> </div>
                            <div class="item"><img src="{{ URL::asset('assets/images/rooms/boat-house5.jpg') }}"
                                    alt="" class="w-100"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="room-details">
                            <h2>Heritage Vintage Boat House </h2>
                            <ul class="nav nav-tabs" id="room-Tab2" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="home-tab2" data-bs-toggle="tab"
                                        ...
                                        aria-controls="home-tab-pane2" aria-selected="true">Overview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab2" data-bs-toggle="tab"
                                        data-bs-target="#profile-tab-pane2" type="button" role="tab"
                                        aria-controls="profile-tab-pane2" aria-selected="false">Amenities</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane show active" id="home-tab-pane2" role="tabpanel"
                                    aria-labelledby="home-tab2" tabindex="0">
                                    <p>Floating gracefully in the heart of the lake, this enchanting retreat offers a truly
                                        one-of-a-kind
                                        experience. Its timeless charm and panoramic water views ensure a stay that feels
                                        both personal and
                                        unforgettable.</p>
                                    <div class="details-icons">
                                        <div class="icon-text">
                                            <div class="icon">
                                                <img src="{{ URL::asset('assets/icons/bed.png') }}" alt="king bed">
                                            </div>
                                            <div class="text">2 Double Bedrooms</div>
                                        </div>
                                        <div class="icon-text">
                                            <div class="icon">
                                                <img src="{{ URL::asset('assets/icons/fork.png') }}" alt="Meals">
                                            </div>
                                            <div class="text">All Meals Inclusive</div>
                                        </div>
                                        <div class="icon-text">
                                        ...
                                        <div class="icon-text">
                                            <div class="icon">
                                                <img src="{{ URL::asset('assets/icons/wifi.png') }}" alt="wifi">
                                            </div>
                            ...
                            <!-- <h4>Staring From ₹25,000 Per Night <span class="symbol-font mx-1">+</span> Taxes </h4> -->
                            <h4>Staring From ₹25,000 Per Night </h4>
                            <a href="javascript:void(0)" class="book-now" data-bs-toggle="modal"
                                data-bs-target="#bookingModal">Book Now</a>
                        </div>
                    </div>
