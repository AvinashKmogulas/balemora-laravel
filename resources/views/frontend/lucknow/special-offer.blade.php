        ...
        <section class="section-padding color-bg">
            <div class="container mb-4">
                <div class="row offer-categories">
                    <div class="col-md-6">
                        <img src="{{ URL::asset('assets/images/offers/Long-Stay.jpg') }}" alt="" class="w-100">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container mb-4">
                <div class="row offer-categories flex-lg-row-reverse">
                    <div class="col-md-6">
                        <img src="{{ URL::asset('assets/images/offers/Ayodhya.jpg') }}" alt="" class="w-100">
                    </div>
                    <div class="col-md-6 ">
                        <div class="room-details offers">
            ...
            <div class="container">
                <div class="row offer-categories">
                    <div class="col-md-6">
                        <img src="{{ URL::asset('assets/images/offers/Buddhist.jpg') }}" alt="" class="w-100">
                    </div>
                    <div class="col-md-6 ">
                        <div class="room-details offers">
